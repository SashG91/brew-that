...
def user_info():
    ...
    while True:
        ...
        if validate_username(name):
            print(f"Hello {name}!\n")
            # Go to spread of users, find the name or email match
            # Return the Customer to the main function
        else:
            # report not found, ask if they want to try again or register

            # return customer object to main program
            print("fill this out")
    return name
